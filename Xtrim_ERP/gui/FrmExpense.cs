...
namespace Xtrim_ERP.gui
{
    public partial class FrmExpense : Form
    {
        ...
        public FrmExpense(XtrimControl x)
        {
            InitializeComponent();
            xC = x;
            initConfig();
        ...
        private void setControl(String deptId)
        {
            ...
            txtID.Value = expn.expenses_id;
            txtCode.Value = expn.expenses_code;
            txtNameT.Value = expn.expenses_name_t;
        ...
        {
            expn.expenses_id = txtID.Text;
            expn.expenses_code = txtCode.Text;
            expn.expenses_name_t = txtNameT.Text;
