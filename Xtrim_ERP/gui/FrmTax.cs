...
namespace Xtrim_ERP.gui
{
    public partial class FrmTax : Form
    {
        ...
        String userIdVoid = "";
        MainMenu4 menu;
        public FrmTax(XtrimControl x, MainMenu4 m)
        {
            InitializeComponent();
            xC = x;
            menu = m;
        ...
        private void setGrfDeptH()
        {
            ...
            grfItemT.DataSource = xC.xtDB.taxDB.selectAll();
        ...
        {
            tax = xC.xtDB.taxDB.selectByPk1(deptId);
            txtID.Value = tax.tax_id;
            txtCode.Value = tax.tax_code;
            txtNameT.Value = tax.tax_name_t;
        ...
        private void setTax()
        {
            tax.tax_id = txtID.Text;
            tax.tax_code = txtCode.Text;
            tax.tax_name_t = txtNameT.Text;
