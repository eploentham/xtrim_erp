...
using Resources = global::Xtrim_ERP.Properties.Resources;
using Settings = global::Xtrim_ERP.Properties.Settings;
...
namespace Xtrim_ERP.RichTextEditor
{
    ...
    public class C1TextEditorRibbon : C1.Win.C1Ribbon.C1Ribbon
    {
        ...
        void InitApplicationMenu()
        {
            ...
            ((AppMenuTabs.PrintTab)((RibbonAppMenuTab)items["PrintTab"]).Control).Ribbon = this;
