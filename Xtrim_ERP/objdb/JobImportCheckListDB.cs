    ...
    public class JobImportCheckListDB
    {
        ...
        private JobImportCheckList setJobImportCheckList(DataTable dt)
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                jcl1.check_list_date  = dt.Rows[0][jcl.check_list_date] != null ? dt.Rows[0][jcl.check_list_date].ToString() : "";
                jcl1.type_of_bl  = dt.Rows[0][jcl.type_of_bl] != null ? dt.Rows[0][jcl.type_of_bl].ToString() : "";
                jcl1.email_do  = dt.Rows[0][jcl.email_do] != null ? dt.Rows[0][jcl.email_do].ToString() : "";
                jcl1.privi1_id  = dt.Rows[0][jcl.privi1_id] != null ? dt.Rows[0][jcl.privi1_id].ToString() : "";
                jcl1.privi2_id  = dt.Rows[0][jcl.privi2_id] != null ? dt.Rows[0][jcl.privi2_id].ToString() : "";
                jcl1.privi1_date  = dt.Rows[0][jcl.privi1_date] != null ? dt.Rows[0][jcl.privi1_date].ToString() : "";
                jcl1.privi2_date  = dt.Rows[0][jcl.privi2_date] != null ? dt.Rows[0][jcl.privi2_date].ToString() : "";
                jcl1.privi1_desc  = dt.Rows[0][jcl.privi1_desc] != null ? dt.Rows[0][jcl.privi1_desc].ToString() : "";
                jcl1.privi2_desc  = dt.Rows[0][jcl.privi2_desc] != null ? dt.Rows[0][jcl.privi2_desc].ToString() : "";
                jcl1.doc_authen1_id  = dt.Rows[0][jcl.doc_authen1_id] != null ? dt.Rows[0][jcl.doc_authen1_id].ToString() : "";
                jcl1.doc_authen2_id  = dt.Rows[0][jcl.doc_authen2_id] != null ? dt.Rows[0][jcl.doc_authen2_id].ToString() : "";
                jcl1.doc_authen3_id  = dt.Rows[0][jcl.doc_authen3_id] != null ? dt.Rows[0][jcl.doc_authen3_id].ToString() : "";
                jcl1.doc_authen1_date  = dt.Rows[0][jcl.doc_authen1_date] != null ? dt.Rows[0][jcl.doc_authen1_date].ToString() : "";
                jcl1.doc_authen2_date  = dt.Rows[0][jcl.doc_authen2_date] != null ? dt.Rows[0][jcl.doc_authen2_date].ToString() : "";
                jcl1.doc_authen3_date  = dt.Rows[0][jcl.doc_authen3_date] != null ? dt.Rows[0][jcl.doc_authen3_date].ToString() : "";
                jcl1.enter_bl  = dt.Rows[0][jcl.enter_bl] != null ? dt.Rows[0][jcl.enter_bl].ToString() : "";
                jcl1.insurance_atten  = dt.Rows[0][jcl.insurance_atten] != null ? dt.Rows[0][jcl.insurance_atten].ToString() : "";
                jcl1.email_do1  = dt.Rows[0][jcl.email_do1] != null ? dt.Rows[0][jcl.email_do1].ToString() : "";
                jcl1.email_do1_date  = dt.Rows[0][jcl.email_do1_date] != null ? dt.Rows[0][jcl.email_do1_date].ToString() : "";
                jcl1.do_date_send  = dt.Rows[0][jcl.do_date_send] != null ? dt.Rows[0][jcl.do_date_send].ToString() : "";
                jcl1.do_date_receive  = dt.Rows[0][jcl.do_date_receive] != null ? dt.Rows[0][jcl.do_date_receive].ToString() : "";
                jcl1.tax_date_send  = dt.Rows[0][jcl.tax_date_send] != null ? dt.Rows[0][jcl.tax_date_send].ToString() : "";
                jcl1.tax_date_receive  = dt.Rows[0][jcl.tax_date_receive] != null ? dt.Rows[0][jcl.tax_date_receive].ToString() : "";
                jcl1.exp1_date_send  = dt.Rows[0][jcl.exp1_date_send] != null ? dt.Rows[0][jcl.exp1_date_send].ToString() : "";
                jcl1.exp1_date_receive  = dt.Rows[0][jcl.exp1_date_receive] != null ? dt.Rows[0][jcl.exp1_date_receive].ToString() : "";
                jcl1.exp2_date_send  = dt.Rows[0][jcl.exp2_date_send] != null ? dt.Rows[0][jcl.exp2_date_send].ToString() : "";
                jcl1.exp2_date_receive  = dt.Rows[0][jcl.exp2_date_receive] != null ? dt.Rows[0][jcl.exp2_date_receive].ToString() : "";
                jcl1.receipt_date  = dt.Rows[0][jcl.receipt_date] != null ? dt.Rows[0][jcl.receipt_date].ToString() : "";
                jcl1.receipt_copy_date  = dt.Rows[0][jcl.receipt_copy_date] != null ? dt.Rows[0][jcl.receipt_copy_date].ToString() : "";
                jcl1.accept_tender  = dt.Rows[0][jcl.accept_tender] != null ? dt.Rows[0][jcl.accept_tender].ToString() : "";
                jcl1.advance_billing  = dt.Rows[0][jcl.advance_billing] != null ? dt.Rows[0][jcl.advance_billing].ToString() : "";
                jcl1.approve_date  = dt.Rows[0][jcl.approve_date] != null ? dt.Rows[0][jcl.approve_date].ToString() : "";
                jcl1.parent1  = dt.Rows[0][jcl.parent1] != null ? dt.Rows[0][jcl.parent1].ToString() : "";
                jcl1.date_create  = dt.Rows[0][jcl.date_create] != null ? dt.Rows[0][jcl.date_create].ToString() : "";
                jcl1.date_modi  = dt.Rows[0][jcl.date_modi] != null ? dt.Rows[0][jcl.date_modi].ToString() : "";
                jcl1.date_cancel  = dt.Rows[0][jcl.date_cancel] != null ? dt.Rows[0][jcl.date_cancel].ToString() : "";
                jcl1.user_create  = dt.Rows[0][jcl.user_create] != null ? dt.Rows[0][jcl.user_create].ToString() : "";
                jcl1.user_modi  = dt.Rows[0][jcl.user_modi] != null ? dt.Rows[0][jcl.user_modi].ToString() : "";
                jcl1.user_cancel  = dt.Rows[0][jcl.user_cancel] != null ? dt.Rows[0][jcl.user_cancel].ToString() : "";
                jcl1.remark  = dt.Rows[0][jcl.remark] != null ? dt.Rows[0][jcl.remark].ToString() : "";
                jcl1.active  = dt.Rows[0][jcl.active] != null ? dt.Rows[0][jcl.active].ToString() : "";
            }
            else
            {
