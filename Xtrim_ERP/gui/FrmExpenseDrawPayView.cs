...
{
    public partial class FrmExpenseDrawPayView : Form
    {
        XtrimControl xC;
        ExpensesDraw expn;
        Font fEdit, fEditB;
        ...
        public FrmExpenseDrawPayView(XtrimControl x)
        {
            InitializeComponent();
            xC = x;
            initConfig();
        ...
        private void FrmExpenseDrawPayView_Load(object sender, EventArgs e)
        {
