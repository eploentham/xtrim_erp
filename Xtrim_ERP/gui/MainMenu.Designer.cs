namespace Xtrim_ERP.gui
{
    partial class MainMenu
    {
        ...
        private void InitializeComponent()
        {
            ...
            c1TopicLink2.Text = "Export JOB";
            c1TopicLink3.Text = "Other ";
            c1TopicPage1.Links.Add(c1TopicLink1);
            c1TopicPage1.Links.Add(c1TopicLink2);
            c1TopicPage1.Links.Add(c1TopicLink3);
            c1TopicPage1.Text = "Open JOB";
            c1TopicPage2.ImageList = null;
            c1TopicLink4.Text = "ออกใบแจ้งหนี้";
            c1TopicLink5.Text = "ล้างหนี้";
            c1TopicLink6.Text = "ยกเลิกใบแจ้งหนี้";
            c1TopicPage2.Links.Add(c1TopicLink4);
            c1TopicPage2.Links.Add(c1TopicLink5);
            c1TopicPage2.Links.Add(c1TopicLink6);
            c1TopicPage2.Text = "AR ลูกหนี้";
            c1TopicPage3.ImageList = null;
            c1TopicLink7.Text = "ใบสำคัญจ่าย (ใบเบิกเงิน)";
            c1TopicLink8.Text = "พิมพ์ ใบภาษีหัก ณ.ที่จ่าย";
            c1TopicPage3.Links.Add(c1TopicLink7);
            c1TopicPage3.Links.Add(c1TopicLink8);
            c1TopicPage3.Text = "Account";
            c1TopicPage4.ImageList = null;
            c1TopicLink9.Text = "คิวงาน";
            c1TopicPage4.Links.Add(c1TopicLink9);
            c1TopicPage4.Text = "Messager";
            c1TopicPage5.ImageList = null;
            c1TopicLink10.Text = "ประเทศ";
            c1TopicLink11.Text = "จังหวัด";
